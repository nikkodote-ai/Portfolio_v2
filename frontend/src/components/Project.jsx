import { styled, Typography, Paper, Stack, Box, Grow } from "@mui/material";
    ...
    <a href={props.url}>
      ...
      <StyledBox>
        <StyledPaper
          ...
          >
            <StyledTitle sx={{ fontSize: { xs: 40, sm: 30, md: 80 } }}>
              {props.title}
            </StyledTitle>
            <Box height="2px" width="120%" bgcolor="#ffffff" />
            <Typography sx={{color: "#ffffff", fontWeight:"300", fontSize:{xs:"23px", sm:"30px"}}}> {props.description}</Typography>
          </Stack>
        </StyledPaper>
      </StyledBox>
              </a>
