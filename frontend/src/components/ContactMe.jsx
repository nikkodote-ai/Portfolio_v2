  ...
  return (
    ...
    {/* <Typography>Contact Me! <KeyboardDoubleArrowDown/> </Typography> */}
        <Stack direction="row" justifyContent={"center"} alignContent={"center"}  spacing={8}>
          <a href={`mailto:nikko.dote@gmail.com`} rel="noopener noreferrer">

   <Email  fontSize='large'/>
          </a>
            
            <a href="https://www.linkedin.com/in/nikkodote" rel="noopener noreferrer">
    <LinkedIn fontSize="large" />

            </a>

          <a href="https://github.com/nikkodote-ai" rel="noopener noreferrer">
    <GitHub fontSize="large" />
            
          </a>

          <a href="https://www.instagram.com/thenikkodote/">
